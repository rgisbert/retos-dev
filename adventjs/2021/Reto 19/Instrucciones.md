...
Con motivo de las fechas más bonitas del año, [en Platzi han lanzado una promoción muy especial](https://platzi.com/precios/) porque **la educación es un regalo 🎁 para siempre**.
...
Mirando todo el tema de Platzi, además nos hemos dado cuenta que tienen [un descuento especial para Navidad](https://platzi.com/precios/). ¿No sabes qué regalar? **Regala conocimiento 🎓**.


## Original

Enlace al [reto 19](https://adventjs.dev/challenges/19).
